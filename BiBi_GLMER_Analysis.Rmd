...
Map of points on top of raster - looks good! 
```{r}
# plot climate data
plot(Bison_HSI,
     main = "Bison HSI",
...
# writing outputs for graphing in ArcGIS
```{r}
writeRaster(Bison_HSI, "Bison_HSI-new2 - June 20 2022.tif", overwrite=TRUE)


st_write(JObs.sf, "journal.obs-new3.shp", overwrite = TRUE)

```


Abundance model (archived bc it had similar results to presence model)
```{r}
...
Generate output table with model results - for plotting. 
```{r}
